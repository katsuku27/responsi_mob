<template>
    <ion-modal :is-open="isOpen" @did-dismiss="cancel">
        <ion-header>
            <ion-toolbar>
                <ion-title>{{ editingId ? 'Edit' : 'Add' }} Petualangan</ion-title>
        ...
        <ion-content>
            ...
            <ion-item>
                <ion-textarea v-model="localTodo.description" label="Petualangan" label-placement="floating"
            ...
            <ion-row>
                <ion-col>
                    <ion-button type="button" @click="input" shape="round" color="primary" expand="block">
                        {{ editingId ? 'Edit' : 'Add' }} Petualangan
                    </ion-button>
                </ion-col>
            </ion-row>
        </ion-content>
...
// update local todo dengan props
